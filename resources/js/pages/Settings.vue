<script setup>
import { PublishContainer, Header, Button, DocsCallout} from '@statamic/cms/ui';
...
<template>
    ...
    <div>
        ...
        <DocsCallout :topic="'Faviconator'" :url="'https://statamic.com/addons/dryven/faviconator'" />
    </div>
</template>